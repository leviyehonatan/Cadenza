...
// Cadenza: vendored from https://github.com/Sjhunt93/Piano-Roll-Editor (MIT,
// see LICENSE in this folder). JuceHeader.h replaced with the module include
// (Cadenza uses JUCE via CMake without a generated JuceHeader).
